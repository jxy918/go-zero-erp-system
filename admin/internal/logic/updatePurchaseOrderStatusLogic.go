...
type UpdatePurchaseOrderStatusLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewUpdatePurchaseOrderStatusLogic(ctx context.Context, svcCtx *svc.ServiceContext) *UpdatePurchaseOrderStatusLogic {
	return &UpdatePurchaseOrderStatusLogic{
...
func (l *UpdatePurchaseOrderStatusLogic) UpdatePurchaseOrderStatus(req *types.PurchaseOrderStatusRequest) (resp *types.EmptyResponse, err error) {
